...
type Options struct {
	...
	VariablePath                CSV           `short:"p" long:"variable-path"                  env:"TERRAFORM_VARIABLE_PATH"        description:"Dotted path to a string inside an HCL variable (e.g. a.image). \"*\" fans out across all keys at that level. Omit to replace the whole value."`
